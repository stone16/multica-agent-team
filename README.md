...
[English / English README](README.en.md) · [中文](README.md) · [完整运行模型](docs/operating-model.md) · [官方对接宣传包](docs/official-outreach.md)
...
> 这张图是提交到仓库的 SVG，因此会直接显示在 GitHub 默认 README 页面中。英文版本还保留了可检查的 Mermaid 流程图源码。
